...
from dataset.h36m_dpo import H36MDataset_DPO, H36MDataset_KTO
...
from dataset.InstaVariety_dpo import InstaVariety_DPO, InstaVariety_KTO
...
class KTODataset(data.Dataset):
    ...
    def __init__(self,
        ...
        if cfg.training.get('dpo', False) or cfg.training.get('kto', False):                  # for DPO training set length control
            ...
            self.tot_size = cfg.dataset.tot_size
