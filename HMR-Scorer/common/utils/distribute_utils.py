...
def init_distributed_mode_wo_slurm(port = None, master_port=29500):
    """Initialize slurm distributed training environment.
    ...
    #dist.init_process_group(backend=dist_backend, init_method='tcp://10.96.183.234:29500', rank=0, world_size=2)
